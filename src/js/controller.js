...
let url1 = 'https://forkify-api.jonas.io/api/v2/recipes/?search=';
let url2 = 'https://forkify-api.jonas.io/api/v2/recipes/';
            ...
            ${recipe.ingredients
              .map(element => {
                ...
                <li class="recipe__ingredient">
                  ...
                  <div class="recipe__quantity">${element.quantity ? element.quantity : ''}</div>
